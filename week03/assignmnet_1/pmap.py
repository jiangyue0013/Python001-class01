    ...
    with klass(max_workers=num_of_workers) as executor:
        ...
        for t in task_generator:
            ...
            if enable_measurement:
                future = executor.submit(utils.measture_time, func, *args)
            else:
...
def main():
    ...
    parser.add_argument('-w', action='count', default=0, help='write to tile')
    ...
    ip_range = utils.parse_ip_range(args.ip)
